...
public class SeleniumTestNGParametersTest {

	WebDriver driver;

	@BeforeTest
	@Parameters( {"activeBrowser", "chromeDriverVersion"} )
	public void initialiseDriver(String browser, String chromeDriverVersion){
		
		System.out.println("Active browser***"+browser);
		System.out.println("Driver Version***"+chromeDriverVersion);
